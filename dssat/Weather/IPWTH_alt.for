...
C=======================================================================
     ...
     &    TAMP, TAV, TDEW, TMAX, TMIN, VAPR, ETO, WINDHT, !Output
...
!-----------------------------------------------------------------------
     ...
     &  WINDSP,XLAT,XLONG,CCO2,RHUM, VAPR, DCO2, OZON7,ETO, KCB
...
!       Use YRDOYWY here (different argument than previous call)
     ...
     &    OZON7_A, PAR_A, WFPASS,                         !Output
     &    RAIN_A, RHUM_A, SRAD_A, TDEW_A, TMAX_A,         !Output
     &    TMIN_A, VAPR_A, WINDSP_A, YRDOY_A, YREND,ETO_A)
        IF (ErrCode > 0) RETURN 
      ENDIF
...
!-----------------------------------------------------------------------
      ...
      REAL PAR, RAIN, SRAD, TDEW, TMAX, TMIN, WINDSP, RHUM, VAPR, DCO2,ETO
      REAL OZON7
...
!     Arrays of weather data -- up to one year stored.
     ...
     &          OZON7_A, 
     &          RAIN_A, TDEW_A, WINDSP_A, PAR_A, RHUM_A, VAPR_A,ETO_A
...
! ETO  Daily  potential evapotranspiration short-grass [mm]
